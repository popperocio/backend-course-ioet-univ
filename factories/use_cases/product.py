...
from app.src.use_cases import ListProducts, FindProductById, CreateProduct, EditProduct, DeleteProduct, FilterProductsByStatus
...
def filter_products_by_status() -> FilterProductsByStatus:
